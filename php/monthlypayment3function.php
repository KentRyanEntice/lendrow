...
function payInterest3($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '3 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '3 Months' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_3 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
