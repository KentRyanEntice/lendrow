...
function payInterest7($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '7 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '7 Months' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_7 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
