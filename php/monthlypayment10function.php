...
function payInterest10($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '10 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '10 Months' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_10 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
