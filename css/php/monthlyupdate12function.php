...
function updateInterest12($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '12 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '12 Months' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_12 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
