...
function payInterest2($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '2 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '2 Months' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_2 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
