...
function updateInterest10($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '10 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '10 Months' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_10 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
