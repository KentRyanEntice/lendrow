...
function payInterest4($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '4 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '4 Months' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_4 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
