...
function updateInterest9($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '9 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '9 Months' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_9 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
