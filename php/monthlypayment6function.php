...
function payInterest6($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '6 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '6 Months' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_6 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
