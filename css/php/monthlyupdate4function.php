...
function updateInterest4($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '4 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '4 Months' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_4 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
