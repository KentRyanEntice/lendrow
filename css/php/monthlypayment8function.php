...
function payInterest8($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '8 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '8 Months' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_8 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
