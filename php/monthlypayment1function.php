...
function payInterest1($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '1 Month') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '1 Month' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_1 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
