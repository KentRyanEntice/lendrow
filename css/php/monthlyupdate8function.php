...
function updateInterest8($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '8 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '8 Months' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_8 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
