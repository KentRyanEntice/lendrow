...
function payInterest5($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '5 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '5 Months' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_5 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
