...
function updateInterest7($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '7 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '7 Months' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_7 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
