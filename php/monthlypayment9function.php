...
function payInterest9($connection, $sender, $mobile, $amount, $receiver, $applicationId, $id) {
    ...
    if ($rowTerm['term'] === '9 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE term = '9 Months' AND id = ?;";
	...
	$paymentUpdate = "UPDATE financial_details SET month_9 = 'Pending', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
