...
function updateInterest6($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '6 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '6 Months' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_6 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
