...
function updateInterest3($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '3 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '3 Months' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_3 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
