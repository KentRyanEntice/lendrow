...
function updateInterest1($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '1 Month') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '1 Month' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_1 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
