...
function updateInterest5($connection, $applicationId, $id) {
	...
	if ($rowTerm['term'] === '5 Months') {
        $statusUpdate = "UPDATE financial_details SET status = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE term = '5 Months' AND id = ?;";
		...
		$paymentUpdate = "UPDATE financial_details SET month_5 = 'Paid', updated_at = CURRENT_TIMESTAMP WHERE id = ?;";
